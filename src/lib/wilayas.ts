...
export const wilayas: Wilaya[] = [
  ...
  { id: 49, name: "Timimoun", ar_name: "تيميمون" },
  { id: 50, name: "Bordj Baji Mokhtar", ar_name: "برج باجي مختار" },
  { id: 51, name: "Ouled Djellal", ar_name: "أولاد جلال" },
  { id: 52, name: "Béni Abbès", ar_name: "بني عباس" },
  { id: 53, name: "In Salah", ar_name: "عين صالح" },
  { id: 54, name: "In Guezzam", ar_name: "عين قزام" },
  { id: 55, name: "Touggourt", ar_name: "تقرت" },
  { id: 56, name: "Djanet", ar_name: "جانت" },
  { id: 57, name: "El M'ghair", ar_name: "المغير" },
  { id: 58, name: "El Menia", ar_name: "المنيعة" },
];